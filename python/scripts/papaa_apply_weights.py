...
parser.add_argument('-c', '--classifier_summary',
                    help='folder location of classifier summary file')
...
classifier_file = os.path.join(args.classifier_summary, 'classifier_summary.txt')
